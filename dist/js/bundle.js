...
function clas() {
  ...
  axios.get("http://localhost:3000/menuData").then(function (menuData) {
    menuData.data.forEach(function (_ref) {
      var src = _ref.src,
        alt = _ref.alt,
        title = _ref.title,
        descr = _ref.descr,
...
/* harmony import */ var _server_server__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./server/server */ "./src/modules/server/server.js");
...
function slider(_ref) {
  ...
  //$$$$$$$--carusel slider--$$$$$$$$$//
  slideInner.style.width = "".concat(100 * slides.length, "%");
  ...
  next.addEventListener("click", function () {
    ...
    slideInner.style.transform = "translateX(-".concat(offset, "px)");
...
function tab(tabsSelector, tabsContentSelector, tabsParentSelector, activeClass) {
  // tabs
  var tabParenetElement = document.querySelector(tabsParentSelector),
  ...
  function hideTabContent() {
    tabChildElements.forEach(function (item) {
      item.classList.remove(activeClass);
    });
    tabContentElements.forEach(function (item) {
  ...
  hideTabContent();
  showTabContent();
  tabParenetElement.addEventListener("click", function (event) {
    if (event.target && event.target.classList.contains(tabsSelector.slice(1))) {
      tabChildElements.forEach(function (item, index) {
...
function timer(id, deadline) {
  ...
  function setClock(selector, endtime) {
    var timerElement = document.querySelector(selector),
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_7__["default"])(".timer", '2023-06-04');
});
})();
